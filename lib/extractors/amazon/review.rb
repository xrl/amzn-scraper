      ...
      REVIEW_EXTRACTION =
        {
         :star_rating           => [{:params => [:css, "div + div > span > span > span".freeze]},
                                    ...
                                    {:params => [:at, 0]},
                                    {:params => [:to_f]}],
         :review_title          => [{:params => [:css, "div + div > span + span > b".freeze]},
                                    {:params => [:first]},
                                    {:params => [:text]},
                                    {:params => [:gsub,/\s{2,}/,' ']}],
         :date                  => [{:params => [:css, "div + div > span + span > nobr".freeze]},
                                    {:params => [:first]},
                                    {:params => [:text]}],
         :name                  => [{:params => [:css, "div + div + div > div > div + div > a > span".freeze]},
                                    {:params => [:text]},
                                    {:params => [:gsub,/\s{2,}/,' ']},
                                    {:params => [:gsub,/\(REAL NAME\)/,'']}],
         :real_name             => [{:params => [:css, "div + div + div > div > div + div > a > span".freeze]},
                                    {:params => [:text]},
                                    {:params => [:gsub,/\s{2,}/,' ']},
                                    {:params => [:match,/\(REAL NAME\)/]},
                                    {:params => nil, :block => lambda{|x| !x.nil?}}],
         :verified_purchase     => [{:params => [:css, "div + div + div > span > b".freeze]},
                                    {:params => [:text]},
                                    {:params => [:eql?,"Amazon Verified Purchase".freeze]}],
         :cross_referenced_from => [{:params => [:css, "div + div + div + div > b > span + a".freeze]},
                                    {:params => [:first]},
                                    {:params => [:[],'href']},
                                    {:params => [:match,/([A-Z0-9]{2,})/]},
                                    {:params => [:[],0]}],
         # :cross_referenced_from => [{:params => [:css, "div + div + div + div > b > span + a".freeze]},
         #                            {:params => [:first]},
         #                            {:params => [:text]},
         #                            {:params => [:gsub,/\s{2,}/,' ']},
         #                            {:params => [:strip]}],
         :review_body           => [{:params => [:css, "div + div + div + div"]},
